...
* In 2025 INFORMS published a free resource: [The INFORMS Analytics Framework](https://info.informs.org/analytics-framework). This framework is free to download and provides a roadmap to analytics success for any project or program.
...
* Consider the [Certified Analytics Professional](https://www.certifiedanalytics.org/) Which includes three levels of certification for wherever you are in your career journey.
...
INFORMS has made substantial improvements in the past 2 years to bring more value to analytics professionals, building on the core of what we've done for over 70 years. If you work in analytics, take a serious look at joining or at least using all the fantastic free resources to make smarter decisions for a better world.
